...
##tree(取属名前三字符，种名前2字符组成)
tree = '(((((((GYPHI,(HALAL,BUTHE)),AQUCH),GYPBA),CATAU),(PICPU,(TAEGU,PSEHU))),NIPNI),GALGA)'
tree1 = tree.replace(',',' ')

## species in different group
TARGETSPECIES = 'GYPHI;GYPBA;CATAU' ##目标物种
OUTGROUP = 'BUTHE;HALLE;AQUCH' ##夹在目标物种之间的物种
CONSERVE = 'GALGA;PICPU;TAEGU;PSEHU;NIPNI' ##树上面的其他物种

##motifled
TARGETSPECIES = 'RHOJI;FRAAR' ##目标物种
OUTGROUP = 'RHOSA;RHOWA;RHOCR;ARATH;GLYMA;;HALLE;AQUCH' ##夹在目标物种之间的物种
CONSERVE = 'ORYSA;COPCH' ##树上面的其他物种

##(Osat,Cchi,Rcre,Rsac,Rwal,Rjup,Atha,Gmax,Aphy,Cmel,Csat,Mdom,Rchi,Fart)


## path to several important tools
##bin_path:lastz_CNM.pl脚本
##multi_bin里面的run_multiz.py脚本
##msaview_bin:msa_view命令
##bin_path = '/home/zdh/Projects/Scavenge/68.CNE/01.genome_alignment/bin'
bin_path = '/home/lx_sky6/yt/script/paper-zhang2014-master/Whole_genome_alignment/pairwise/bin'
#multi_bin = '/home/zdh/Projects/Scavenge/68.CNE/01.genome_alignment/02.CNE/01.multiple/bin'
multi_bin = '/home/lx_sky6/yt/script/paper-zhang2014-master/Whole_genome_alignment/multiple/bin'
#msaview_bin = '/home/zdh/Tools/05.48birds/Highly_conserved_elements.bak/bin'
msaview_bin = '/home/lx_sky6/yt/script/paper-zhang2014-master/Highly_conserved_elements/bin'
